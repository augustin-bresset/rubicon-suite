# ops/migration/import/import_missing_labor.py
...
# Run via: docker compose exec -T odoo odoo shell -d rubicon --no-http < ops/migration/import/import_missing_labor.py
