...
if __name__ == '__main__':
    ...
    raw_to_data(
        ...
        fieldnames=['id', 'name', 'doc_type_code', 'doc_type_id', 'legacy_id',
                    ...
                    'currency_legacy', 'total_qty', 'total_cost', 'total_profit',
                    'total_amount', 'freight_insurance',
                    'total_cif', 'footnotes'],
